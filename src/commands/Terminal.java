...
public void Cat(String cat) throws FileNotFoundException, IOException {
        ...
        */
        ...
        for(int i = 0; i < list.size(); i++) {
            try (BufferedWriter bw= new BufferedWriter(new FileWriter(Arr_cat[1], true))) {
                String s;
                s = list.get(i);
                bw.write(s);
                bw.newLine();
...
*/
    ...
    public void Rmdir(String Rmdir) {
           ...
           File dir=new File(str[str.length-1]);
    ...
    public void Mkdir(String Dirctory ) throws IOException{
        ...
        File New_Dir = new File(s1[s1.length-1]);
